...
def test_bless_foo_into_protocol(foo_without_bar: FooModel, test_session: Session):
    foo_id = foo_without_bar.id
    ...
    proto_again = FooProtocol.model_validate(loaded)
    assert proto_again == proto
